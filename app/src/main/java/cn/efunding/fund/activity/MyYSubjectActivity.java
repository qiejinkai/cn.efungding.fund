...
import cn.efunding.fund.adapter.MyYSubjectAdapter;
 ...
 */
public class MyYSubjectActivity extends AppCompatActivity {

    private String bar_title ="我的跃进宝";
    private PullToRefreshListView plv;

    private List<YSubject> list = new ArrayList<YSubject>();
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.me_subject_y_page);

        initBar();
        initPage();
        list.add(new YSubject("跃进宝1号",20));

        final MyYSubjectAdapter adapter = new MyYSubjectAdapter(this,list);
    ...
    private void initBar(){
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(MyYSubjectActivity.this,MeActivity.class));
                finish();
